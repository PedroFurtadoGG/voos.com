...
<body>
   <div class="global-wrap">
      ...
      <div class="container">
         <h1 class="page-title">Cadastro de Poltronas</h1>
      </div>
      <div class="container">
         <div class="row">
            <div class="col-md-14">
               <div class="row">
                  <div class="col-md-10">
                     <form action="actions/cadastrarPoltrona.jsp" name="cadastrarVoo" method="post">
                        ...
                        <div class="form-group">
                           <label>Tipo</label>
                           <input class="form-control" required type="text" name="tipo" />
                        </div>
                       <div class="form-group">
                           <label>Aviao</label>
